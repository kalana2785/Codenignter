...
<?php endif; ?>
          ...
          <div class="row mb-3">
                  <label for="input1" class="col-sm-2 col-form-label">Request Item Name</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="input2" class="col-sm-2 col-form-label">Request Unit Name</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="input3" class="col-sm-2 col-form-label">Quntity</label>
                  <div class="col-sm-10">
                ...
                <div class="alert alert-warning" role="alert">
                  ...
                  <div class="row mb-3">
                  <label for="input4" class="col-sm-2 col-form-label">Add Quntity</label>
                  <div class="col-sm-10">
